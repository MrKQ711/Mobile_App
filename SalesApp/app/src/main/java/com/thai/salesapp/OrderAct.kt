...
class OrderAct : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var url = "http://10.20.22.144/SalesWeb/get_temp.php?mobile="+UserInfo.mobile
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if(item.itemId == R.id.item_cancel){
            ...
            var url = "http://10.20.22.144/SalesWeb/cancel_order.php?mobile="+UserInfo.mobile
        ...
        if(item.itemId == R.id.item_confirm){
            var url = "http://10.20.22.144/SalesWeb/confirm_order.php?mobile="+UserInfo.mobile
